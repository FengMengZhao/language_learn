...
public class TestFindMaxiumSubarray3{
	public static void main(String args[]){
		...
		*/
		...
		FindMaximumSubarray3 fms3 = new FindMaximumSubarray3(new FindMaxCrossingSubarray()) ;
		fms3.findMaxiumSubarray(stockDifferToPrevious, low, high) ;
		System.out.println(fms3) ;
	}
}